...
@Component({
  selector: 'app-grammer-exam',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './grammer-exam.component.html',
  styleUrls: ['./grammer-exam.component.scss']
})
export class GrammerExamComponent implements OnInit {
  ...
  loadQuestions() {
    this.questionService.getAll().subscribe(qs => {
      this.questions = qs.filter(q => q.examId === this.GRAMMAR_EXAM_ID);
