...
@Component({
  selector: 'app-manage-gre-chemistry',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './manage-gre-chemistry.component.html',
  styleUrls: ['./manage-gre-chemistry.component.scss']
})
export class ManageGreChemistryComponent implements OnInit {
