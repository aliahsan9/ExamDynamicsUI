...
@Component({
  selector: 'app-manage-gre-math',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './manage-gre-math.component.html',
  styleUrls: ['./manage-gre-math.component.scss']
})
export class ManageGreMathComponent implements OnInit {
