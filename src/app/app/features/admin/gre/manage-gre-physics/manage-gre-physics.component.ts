...
@Component({
  selector: 'app-manage-gre-physics',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './manage-gre-physics.component.html',
  styleUrls: ['./manage-gre-physics.component.scss']
})
export class ManageGrePhysicsComponent implements OnInit {
  ...
  readonly QUANTITATIVE_EXAM_ID = 26; 
