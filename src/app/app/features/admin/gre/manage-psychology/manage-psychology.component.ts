...
@Component({
  selector: 'app-manage-psychology',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './manage-psychology.component.html',
  styleUrls: ['./manage-psychology.component.scss']
})
export class ManagePsychologyComponent implements OnInit {
