...
@Component({
  selector: 'app-manage-ielts-reading',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './manage-ielts-reading.component.html',
  styleUrls: ['./manage-ielts-reading.component.scss']
})
export class ManageIeltsReadingComponent implements OnInit {
