...
@Component({
  selector: 'app-manage-ielts-writing',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './manage-ielts-writing.component.html',
  styleUrls: ['./manage-ielts-writing.component.scss']
})
export class ManageIeltsWritingComponent implements OnInit {
