...
@Component({
  selector: 'app-manage-gmat-quantitative-reasoning',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './manage-gmat-quantitative-reasoning.component.html',
  styleUrls: ['./manage-gmat-quantitative-reasoning.component.scss']
})
export class ManageGmatQuantitativeReasoningComponent implements OnInit {
