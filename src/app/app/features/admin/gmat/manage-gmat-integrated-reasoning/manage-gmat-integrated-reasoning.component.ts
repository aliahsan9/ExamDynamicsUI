...
@Component({
  selector: 'app-manage-gmat-integrated-reasoning',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './manage-gmat-integrated-reasoning.component.html',
  styleUrls: ['./manage-gmat-integrated-reasoning.component.scss']
})
export class ManageGmatIntegratedReasoningComponent implements OnInit {
