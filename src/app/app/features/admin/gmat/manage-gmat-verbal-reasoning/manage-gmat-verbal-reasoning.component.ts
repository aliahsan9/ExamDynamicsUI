...
@Component({
  selector: 'app-manage-gmat-verbal-reasoning',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './manage-gmat-verbal-reasoning.component.html',
  styleUrls: ['./manage-gmat-verbal-reasoning.component.scss']
})
export class ManageGmatVerbalReasoningComponent implements OnInit {
