...
@Component({
  selector: 'app-manage-gmat-awa-concepts',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './manage-gmat-awa-concepts.component.html',
  styleUrls: ['./manage-gmat-awa-concepts.component.scss']
})
export class ManageGmatAwaConceptsComponent implements OnInit {
