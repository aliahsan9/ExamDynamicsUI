...
@Component({
  selector: 'app-manage-css-international-relations',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './manage-css-international-relations.component.html',
  styleUrls: ['./manage-css-international-relations.component.scss']
})
export class ManageCssInternationalRelationsComponent implements OnInit {
