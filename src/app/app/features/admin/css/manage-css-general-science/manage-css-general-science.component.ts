...
@Component({
  selector: 'app-manage-css-general-science',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './manage-css-general-science.component.html',
  styleUrls: ['./manage-css-general-science.component.scss']
})
export class ManageCssGeneralScienceComponent implements OnInit {
