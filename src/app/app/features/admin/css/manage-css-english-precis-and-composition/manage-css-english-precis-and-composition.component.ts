...
@Component({
  selector: 'app-manage-css-english-precis-and-composition',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './manage-css-english-precis-and-composition.component.html',
  styleUrls: ['./manage-css-english-precis-and-composition.component.scss']
})
export class ManageCssEnglishPrecisAndCompositionComponent implements OnInit {
