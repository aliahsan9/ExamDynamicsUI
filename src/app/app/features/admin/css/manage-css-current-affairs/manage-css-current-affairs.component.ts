...
@Component({
  selector: 'app-manage-css-current-affairs',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './manage-css-current-affairs.component.html',
  styleUrls: ['./manage-css-current-affairs.component.scss']
})
export class ManageCssCurrentAffairsComponent implements OnInit {
