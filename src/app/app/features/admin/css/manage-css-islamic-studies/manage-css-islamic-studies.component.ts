...
@Component({
  selector: 'app-manage-css-islamic-studies',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './manage-css-islamic-studies.component.html',
  styleUrls: ['./manage-css-islamic-studies.component.scss']
})
export class ManageCssIslamicStudiesComponent implements OnInit {
