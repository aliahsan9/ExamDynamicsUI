...
@Component({
  selector: 'app-manage-css-political-science',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './manage-css-political-science.component.html',
  styleUrls: ['./manage-css-political-science.component.scss']
})
export class ManageCssPoliticalScienceComponent implements OnInit {
