...
@Component({
  selector: 'app-manage-css-pakistan-affairs',
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './manage-css-pakistan-affairs.component.html',
  styleUrls: ['./manage-css-pakistan-affairs.component.scss']
})
export class ManageCssPakistanAffairsComponent implements OnInit {
